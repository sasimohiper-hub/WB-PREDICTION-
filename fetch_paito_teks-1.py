...
HEADERS = {
    ...
    'Referer': 'https://rumusangkanet.com/',
}
...
ALL_SLUGS = [
    ...
    ("milan",                "Milan"),
    ("milwaukee-midday",     "Milwaukee Midday"),
    ("milwaukee-morning",    "Milwaukee Morning"),
    ("mississauga-day",      "Mississauga Day"),
    ("mississauga-evening",  "Mississauga Evening"),
    ("mississauga-midnight", "Mississauga Midnight"),
    ("mississauga-morning",  "Mississauga Morning"),
    ("mississauga-night",    "Mississauga Night"),
    ...
    ("north-carolina-evening","North Carolina Evening"),
    ...
    ("vladimir",             "Vladimir"),
    ("warsaw",               "Warsaw"),
    ("washington-dc-evening","Washington DC Evening"),
...
def scrape_paito_teks(slug):
    ...
    # ── Baca kanan→kiri per baris, bawah→atas (reversed baris) ──
    # Hasil: urut BARU→LAMA, lalu di-reverse → LAMA→BARU
    results_newest_first = []
    seen = set()
    for row in reversed(all_lines):       # baris bawah dulu
        for angka in reversed(row):       # kanan dulu
            if angka not in seen:
                seen.add(angka)
                results_newest_first.append(angka)

    # Balik → LAMA→BARU (result[-1] = terbaru)
    results = list(reversed(results_newest_first))
